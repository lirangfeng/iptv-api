...
```bash
https://raw.githubusercontent.com/lirangfeng/iptv-api/gd/output/result.m3u
```

- IPv6

```bash
https://raw.githubusercontent.com/lirangfeng/iptv-api/gd/output/ipv6/result.m3u
```

- IPv4

```bash
https://raw.githubusercontent.com/lirangfeng/iptv-api/gd/output/ipv4/result.m3u
```

### 点播源

```bash
https://raw.githubusercontent.com/lirangfeng/iptv-api/gd/source.json
```
